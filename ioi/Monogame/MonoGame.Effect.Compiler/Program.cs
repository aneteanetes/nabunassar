...
{
    public static class MonogameShaderCompilerEntry
    {
        ...
        public static int Compile(string[] args)
        {
            ...
            var options = new MonogameEffectCompilerOptions();
        ...
        public class ConsoleEffectCompilerOutput : IEffectCompilerOutput
        {
