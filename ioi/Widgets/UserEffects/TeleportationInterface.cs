...
namespace ioi.Widgets.UserEffects
{
    internal class TeleportationInterface : ScreenWidget
    {
        ...
        public TeleportationInterface(GameHost game, TeleportationAbility teleportationAbility, int availableDistanceInGameMeters) : base(game)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            var imageWorldPosition = Game.CameraMain.ScreenToWorld(new Vector2(pos.X - imageLength , pos.Y - MapEntityFactory.PartyRenderYOffset));
            ...
            var mouseWorldPosition = Game.CameraMain.ScreenToWorld(pos);
