...
namespace ioi.Widgets.UserInterfaces
{
    internal class TitleWidget : ScreenWidget
    {
        ...
        public TitleWidget(GameHost game, string text, Vector2 position, Color color = default, HorizontalAlignment? horizontalAlignment = null, VerticalAlignment? verticalAlignment= null) : base(game)
        {
            _color = color;
            if(_color ==default)
                _color = Color.White;
        ...
        protected override Widget CreateWidget()
        {
            ...
            float sexteenPixels = Game.CameraMain.WorldToScreen(new Vector2(16)).X;
