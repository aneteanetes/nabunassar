...
namespace ioi.Widgets.UserInterfaces.GameWindows.Manipulations.Windows
{
    internal class LootWindow : TwoSideWindow
    {
        ...
        public LootWindow(GameHost game, GameObject container) : base(game)
        {
        ...
        public static void Open(GameHost game, GameObject container)
        {
