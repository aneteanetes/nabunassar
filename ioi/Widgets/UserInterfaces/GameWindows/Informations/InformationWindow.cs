...
using ioi.Extensions.LocalizedStringsExtensions;
using ioi.Struct;
using ioi.Widgets.Base;

namespace ioi.Widgets.UserInterfaces.GameWindows.Informations
{
    internal class InformationWindow : ScreenWidgetWindow
    {
        ...
        public InformationWindow(GameHost game, GameObject gameObject) : base(game)
        {
        ...
        public static void Open(GameHost game, GameObject gameObject)
        {
