...
using ioi.Widgets.UserInterfaces.Stats;
using ioi.Widgets.Views.StatusEffects;

namespace ioi.Widgets.UserInterfaces.PartyUI
{
    internal class HeroPortrait : Grid, IFeatured
    {
        ...
        public HeroPortrait(GameHost game, Hero hero)
        {
            _game = game;
            _hero = hero;
        ...
        private Grid FillStatsPoints(GameHost game, Hero hero)
        {
