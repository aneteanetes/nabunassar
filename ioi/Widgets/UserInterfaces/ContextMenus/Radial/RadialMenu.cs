...
using ioi.Widgets.UserInterfaces.ContextMenus.Radial.Actions;

namespace ioi.Widgets.UserInterfaces.ContextMenus.Radial
{
    internal class RadialMenu : ScreenWidget
    {
        ...
        public RadialMenu(GameHost game, GameObject gameObject, Vector2 position) : base(game)
        {
            GameObject = gameObject;
            Position = position;
        }

        public static void Open(GameHost game, GameObject gameObject, Vector2 position)
        {
