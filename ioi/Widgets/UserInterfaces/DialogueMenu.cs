...
namespace ioi.Widgets.UserInterfaces
{
    internal class DialogueMenu : ScreenWidget
    {
        ...
        public DialogueMenu(GameHost game, GameObject gameObject) : base(game)
        {
        ...
        protected override Widget CreateWidget()
        {
            ...
            //Game.CameraMain.ZoomToPoint(_gameObject.MapObject.Position, 3);

            //Game.CameraMain.ViewOn(_gameObject.MapObject.Position);
        ...
        private Panel SpeakerBubble()
        {
            ...
            var objScreenPosition = Game.CameraMain.WorldToScreen(_gameObject.MapObject.Position);
            ...
            var objWidth = (int)(_gameObject.MapObject.Bounds.BoundingRectangle.Width * Game.CameraMain.Zoom);
        ...
        {
        //    Game.CameraMain.ViewReset();
        //    Game.CameraMain.ZoomOut(_gameObject.MapObject.Position, 3);
            Game.EnableSystems();
            base.Close();
        }
    }
