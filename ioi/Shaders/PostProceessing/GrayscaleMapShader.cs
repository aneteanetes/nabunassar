...
namespace ioi.Shaders.PostProceessing
{
    internal class GrayscaleMapShader : PostProcessShader
    {
        ...
        public GrayscaleMapShader(GameHost game, Func<Rectangle> destination, Func<float> grayIntensive, Texture2D patternTexture = null) : base(game, "Assets/Shaders/GrayscaleMap.fx")
        {
