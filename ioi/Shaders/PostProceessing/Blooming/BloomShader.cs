...
namespace ioi.Shaders.PostProceessing.Blooming
{
    ...
    /// </summary>
    internal class BloomShader : PostProcessShader
    {
        private bool _isNeon;
        public BloomShader(GameHost game, bool isNeon=false, BloomPresets preset = BloomPresets.SuperWide) : base(game, "Assets/Shaders/Bloom.fx")
        {
            _bloomPreset = preset;
            _isNeon = isNeon;
        }
        ...
        /// <returns></returns>
        public RenderTarget2D Draw(Texture2D inputTexture, int width, int height)
        {
        ...
        public override void Draw(GameTime gameTime, bool isLast=true)
        {
            ...
            var bloom = Draw(backBuffer, Game.GraphicsDevice.Viewport.Width, Game.GraphicsDevice.Viewport.Height);
