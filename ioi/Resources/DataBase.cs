...
using ioi.Entities.Data.Abilities;
...
namespace ioi.Resources
{
    internal class DataBase
    {
        ...
        internal Party CreateRandomParty(GameHost game)
        {
            var party = new Party(game);

            party.First = new Hero(game, ioi.Entities.Game.Enums.Archetype.Warrior)
            {
                Tileset = "warrior.png",
                Sex = Sex.Male,
                Name = GetName(Sex.Male),
            };
            party.First.Creature = new Creature( ioi.Entities.Game.Enums.Archetype.Warrior, party.First)
            {
                Archetype = ioi.Entities.Game.Enums.Archetype.Warrior,
            };

            party.Second = new Hero(game, ioi.Entities.Game.Enums.Archetype.Rogue)
            {
                Tileset = "rogue.png",
                Sex = Sex.Female,
                Name = GetName(Sex.Female),
            };
            party.Second.Creature = new Creature(ioi.Entities.Game.Enums.Archetype.Rogue,party.Second)
            {
                Archetype = ioi.Entities.Game.Enums.Archetype.Rogue
            };

            party.Third = new Hero(game, ioi.Entities.Game.Enums.Archetype.Wizard)
            {
                Tileset = "wizard.png",
                Sex = Sex.Male,
                Name = GetName(Sex.Male)
            };
            party.Third.Creature = new Creature(ioi.Entities.Game.Enums.Archetype.Wizard, party.Third)
            {
                Archetype = ioi.Entities.Game.Enums.Archetype.Wizard
            };

            party.Fourth = new Hero(game, ioi.Entities.Game.Enums.Archetype.Priest)
            {
                Tileset = "priest.png",
                Sex = Sex.Female,
                Name = GetName(Sex.Female)
            };
            party.Fourth.Creature = new Creature(ioi.Entities.Game.Enums.Archetype.Priest, party.Fourth)
            {
                Archetype = ioi.Entities.Game.Enums.Archetype.Priest
            };
