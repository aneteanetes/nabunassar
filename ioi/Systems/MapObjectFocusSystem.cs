...
namespace ioi.Systems
{
    internal class MapObjectFocusSystem : BaseSystem
    {
        ...
        public MapObjectFocusSystem(GameHost game) : base(game, Aspect.One(typeof(FocusWidgetComponent)))
        {
        ...
        public override void Update(GameTime gameTime, bool isSystem)
        {
            ...
            var mousePos = Game.CameraMain.ScreenToWorld(mouse.X, mouse.Y);
            ...
            if (focusWidgetComponent!=default)
            {
                if(focusedMapObject!=null)
                {
                    ...
                    if (tiledBase != default)
                    {
                        ...
                        position = Game.CameraMain.WorldToScreen(position);
                    }
                }
