...
using ioi.Entities.Data.ComplexValues;
...
namespace ioi.Entities.Game
{
    internal class Creature : GameObject, IEntity, IClonable<Creature>
    {
        ...
        public Creature(Archetype archetype, Hero hero = default)
        {
            ...
            FormulaName = GameHost.Game.Strings["Entities"][nameof(Creature)];
            HeroLink = hero;
            HPNow = HPMax;
            EnduranceNow = EnduranceMax;
            ArmorClassBase = GameHost.Game.DataBase.GetFromDictionary<int>("Data/Formulas/BaseArmorClassByArchetype.json", archetype.ToString());
        ...
        public HPWounds BattlerWounds()
        {
            ...
            var wounds = GameHost.Game.DataBase.Get<Dictionary<HPWounds, int>>("Data/HPWounds/WoundPercentage.json");
