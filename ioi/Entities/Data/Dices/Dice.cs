...
using ioi.Entities.Data.Dices.Terms;
using ioi.Entities.Data.Rankings;
using ioi.Resources;
using Newtonsoft.Json;

namespace ioi.Entities.Data.Dices
{
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        public DiceRoll Roll()
        {
            ...
            if (rollsCounter == LuckyRoll)
            {
                ...
                var result = GameHost.Randoms.Next(prevAvg, Edges);
        ...
        {
            var result = GameHost.Randoms.Next(1,Edges);
