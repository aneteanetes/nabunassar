...
namespace ioi.Components
{
    ...
    internal class MapObject : BaseComponent, ICollisionActor, IDisposable
    {
        ...
        public MapObject(GameHost game, Vector2 position, ObjectType objType, Entity entity, RectangleF bounds=default, string layer = null, CollisionEventHandler onCollistion = null, MapObject parent = null, bool isMoveable=false) : base(game)
        {
            LayerName = layer;
            Parent = parent;
            Entity = entity;
        ...
        public void Reveal()
        {
            if (!IsVisible)
            {
                ...
                Game.EntityFactoryMap.RemoveCollistion(this);
                ...
                Game.EntityFactoryMap.AddCollistion(this);
