...
namespace Monogame.Extended
{
    ...
    /// </summary>
    public class CustomCollisionComponent : SimpleGameComponent
    {
        ...
        public CustomCollisionComponent(RectangleF boundary)
        {
        ...
        public CustomCollisionComponent(Layer layer = null)
        {
