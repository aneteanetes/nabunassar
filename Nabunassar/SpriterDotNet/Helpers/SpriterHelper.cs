...
namespace SpriterDotNet.Helpers
{
    internal static class SpriterHelper
    {
        ...
        public static void Interpolate(this SpriterVarValue target, SpriterVarValue valA, SpriterVarValue valB, float factor)
        {
            ...
            target.FloatValue = SpriterDotNetMathHelper.Linear(valA.FloatValue, valB.FloatValue, factor);
            target.IntValue = (int)SpriterDotNetMathHelper.Linear(valA.IntValue, valB.IntValue, factor);
        }
        ...
        {
            target.Angle = SpriterDotNetMathHelper.AngleLinear(a.Angle, b.Angle, spin, factor);
            target.X = SpriterDotNetMathHelper.Linear(a.X, b.X, factor);
            target.Y = SpriterDotNetMathHelper.Linear(a.Y, b.Y, factor);
            target.ScaleX = SpriterDotNetMathHelper.Linear(a.ScaleX, b.ScaleX, factor);
            target.ScaleY = SpriterDotNetMathHelper.Linear(a.ScaleY, b.ScaleY, factor);
            target.Alpha = SpriterDotNetMathHelper.Linear(a.Alpha, b.Alpha, factor);
        }
        ...
        public static void Interpolate(this SpriterObject target, SpriterObject a, SpriterObject b, float factor, int spin)
        {
            ...
            target.T = SpriterDotNetMathHelper.Linear(a.T, b.T, factor);
        }
        ...
        public static float AdjustFactor(float factor, SpriterKey key)
        {
            switch (key.CurveType)
            {
                ...
                case SpriterCurveType.Quadratic:
                    factor = SpriterDotNetMathHelper.Bezier(0.0f, key.C1, 1.0f, factor);
                    break;
                case SpriterCurveType.Cubic:
                    factor = SpriterDotNetMathHelper.Bezier(0.0f, key.C1, key.C2, 1.0f, factor);
                    break;
                case SpriterCurveType.Quartic:
                    factor = SpriterDotNetMathHelper.Bezier(0.0f, key.C1, key.C2, key.C3, 1.0f, factor);
                    break;
                case SpriterCurveType.Quintic:
                    factor = SpriterDotNetMathHelper.Bezier(0.0f, key.C1, key.C2, key.C3, key.C4, 1.0f, factor);
                    break;
                case SpriterCurveType.Bezier:
                    factor = SpriterDotNetMathHelper.Bezier2D(key.C1, key.C2, key.C3, key.C4, factor);
                    break;
            }
        ...
        public static float AdjustTime(float targetTime, SpriterKey keyA, SpriterKey keyB, float animationLength)
        {
            ...
            return SpriterDotNetMathHelper.Linear(keyA.Time, nextTime, factor);
        }
        ...
        public static float GetFactor(SpriterKey keyA, SpriterKey keyB, float animationLength, float targetTime)
        {
            ...
            float factor = SpriterDotNetMathHelper.GetFactor(timeA, timeB, targetTime);
