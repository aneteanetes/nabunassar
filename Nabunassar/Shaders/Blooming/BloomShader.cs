...
namespace Nabunassar.Shaders.Blooming
{
    /// <summary>
    /// 
    ...
    internal class BloomShader : PostProcessShader
    {
        ...
        public BloomShader(NabunassarGame game, bool isNeon=false, BloomPresets preset = BloomPresets.SuperWide) : base(game, "Assets/Shaders/Bloom.fx")
        {
            _bloomPreset = preset;
            _isNeon = isNeon;
        }
